...
//During impelementation, we need to redefine all the Properties of interface in class
//We can assign data to properties(variabls in java) using constructor in class
...
//Implementation of interface signature(i.e. Implement abstract method)
//where we should not change any sinature i.e. (Return type, name of method, number of parameters - keep as it is as impelmeted in interface)
 sound()
 {
    console.log("bark...")
 }

...
//To iterate object i.e. to access data
//We can iterate only one object at a time
for (let i in book1)
{
...
//Constructor never retuen any values.
//It is only for assigning value/data to the variables.
//It is called automatically while object creation of class, We don't need to call it seprately...
//For method, we need to call them using object e.g, object name.method name
...
//All objects are independent. They have their own variables and Methods.
//All objects are derived from the same class.
...
let person2=new Person('22222222','Rishabh','Krishna');
